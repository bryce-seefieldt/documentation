...
- It is not necessary to comment every operation in the code; focus on the unstated and high-level intention and avoid commenting straightforward behaviour. 
